...
set_target_properties(clFFT PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/import/clFFT.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/clFFT.dll"
  )
...
set_target_properties(StatTimer PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/import/StatTimer.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/StatTimer.dll"
  )
